...
export class Calleds extends React.Component {
  ...
  columns = [
    ...
    { selector: (row) => row.requested?.surname, name: 'Solicitante', minWidth: '250px', maxWidth: '250px'},
    { selector: (row) => row.reason?.description, name: 'Motivo', minWidth: '160px', maxWidth: '160px'},
    { selector: (row) => row.occurrence?.description, name: 'Ocorrência', minWidth: '200px', maxWidth: '200px'},
